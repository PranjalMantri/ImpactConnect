  ...
  <section className="relative h-screen flex items-center justify-center text-white">
    ...
    <div className="relative z-10 text-center px-4">
      ...
      <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-200 mb-8">
        ...
        donate, volunteer your time, or find a cause that resonates, we're here
        to help you create a meaningful impact.
      </p>
      <div className="flex flex-wrap justify-center gap-4">
        <button className="h-12 px-6 rounded-lg bg-[#1193d4] text-white font-bold text-base hover:opacity-90">
          Explore Projects
        </button>
        <button className="h-12 px-6 rounded-lg bg-white/20 text-white font-bold text-base backdrop-blur-sm hover:bg-white/30">
          Sign Up
        </button>
      </div>
    </div>
